...
public class SingleThreadedSudokuValidatorTest {
    private ISudokuReader reader;
    private boolean expectedOutput;

    public SingleThreadedSudokuValidatorTest(ISudokuReader reader, boolean expectedOutput) {
        this.reader = reader;
    ...
    public void successTest() throws SudokuException {
        AssertX.assertEquals(expectedOutput, new SingleThreadedSudokuValidator(reader).checkSudoku());
    }
}
