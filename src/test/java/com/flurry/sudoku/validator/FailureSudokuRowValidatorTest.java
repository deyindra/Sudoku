...
public class FailureSudokuRowValidatorTest extends AbstractSudokuRowValidatorTest{

    public FailureSudokuRowValidatorTest(ISudokuReader reader,  int row) {
        super(reader, false, row);
    }
    ...
    public void failureTest() throws SudokuException {
        ...
        new RowSudokuValidator(reader,row).checkSudoku();
    }
}
